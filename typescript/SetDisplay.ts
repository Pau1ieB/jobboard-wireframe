const content: HTMLElement = document.getElementById('main')!;
...
export const SetDisplay=(action:string,profile:any,tableString:string,navString:string,profileButtons:Array<any>)=>{
    content.innerHTML = displayList[action](profile,tableString,navString,profileButtons);
}

const AddData=(profile:any,tableString:string,navString:string):string=>`
...
const MainPage=(profile:any,tableString:string,navString:string):string=>`
    <div class='grid-container'>
...
const LoginProfile=(profile:any,tableString:string,navString:string):string=>`
    <div class='grid-container'>
...
const Profile=(profile:any,tableString:string,navString:string,profileButtons:Array<any>):string=>`
    <div class='grid-container'>
...
const ViewApplicant=(profile:any,tableString:string,navString:string):string=>`
    <div class='grid-container'>
...
const EmployerDashboard=(profile:any,tableString:string,navString:string):string=>`
    <div class='grid-container'>
...
const ApplicantDashboard=(profile:any,tableString:string,navString:string):string=>`
    <div class='grid-container'>
        ${GetLabel("grid-area:2/5/4/12",`Welcome: ${profile.name.value}`,"")}
...
const GetButton=(pos:string,text:string,action:string):string=>`
    <a href='${action}' style='${pos}'><button>${text}</button></a>
`;

const GetLabel=(pos:string,text:string,border:string):string=>`
    <label style='${pos}' ${border}>${text}</label>
`;

const GetImage=(style:string,fileName:string):string=>`
    <div class='${style}'>
        <img src='${fileName}'>
    </div>
`
...
const displayList:{[key:string]:any}={
    'AddData':AddData,
    'MainPage':MainPage,
